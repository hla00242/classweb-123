<?php
/**
 * ENG-1061 Dynamic Markdown & Academic Essay Reader
 */
require_once __DIR__ . '/../includes/functions.php';

$paperFile = $_GET['paper'] ?? 'rhetorical-analysis.md';
$paperFile = basename($paperFile);
$fullPath = __DIR__ . '/' . $paperFile;

$defaultTitle = 'ENG-1061 Essay Reader';
...
$pageTitle = $defaultTitle . ' | ENG-1061 Reader';
$metaDescription = "Read '" . $defaultTitle . "' by Hesten A. (Sheldon) for ENG-1061 English Composition & Critical Inquiry.";
$activePage = 'courses';
$rootPath = '../';
...
<main class="reader-container">
    <nav class="breadcrumb-nav" aria-label="Breadcrumb">
        ...
        <a href="index.php">ENG-1061</a>
        <span class="breadcrumb-separator">/</span>
        <span id="breadcrumb-paper-title"><?= e($defaultTitle) ?></span>
    </nav>

    <header id="academic-header" class="academic-header">
        <span id="paper-badge" class="academic-header-tag">ENG-1061 &bull; Rhetorical Analysis Essay</span>
        ...
        <div class="academic-meta-grid">
            ...
            <div class="meta-item">
                ...
                <span id="paper-course" class="meta-value">ENG-1061: English Composition</span>
            </div>
            <div class="meta-item">
    ...
    <section class="citation-box" id="citation-box">
        ...
        <div id="citation-text" class="citation-text">
            Sheldon, Hesten A. "<?= e($defaultTitle) ?>." ENG-1061: English Composition & Critical Inquiry, Community College of Vermont / Vermont State Colleges, 2026.
        </div>
    </section>
    ...
    <footer class="reader-nav-footer">
        <div class="paper-nav-card">
            ...
            <a href="index.php" class="paper-nav-link">&larr; Back to ENG-1061 Hub</a>
        </div>
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        document.getElementById('paper-title').textContent = parsed.meta.title || 'Academic Essay';
        document.title = `${parsed.meta.title} | ENG-1061 Reader`;
        ...
        document.getElementById('citation-text').textContent = 
            `Sheldon, Hesten A. "${parsed.meta.title}." ENG-1061: English Composition & Critical Inquiry, Community College of Vermont / Vermont State Colleges, 2026.`;
    } catch (err) {
        document.getElementById('paper-content').innerHTML = `
            <div style="padding: 2rem; background: var(--status-warning-bg); border-radius: var(--radius-md); border: 1px solid var(--status-warning);">
                ...
                <p>Ensure <code>${paperFile}</code> exists in the <code>eng1061/</code> directory.</p>
            </div>
        `;
    }
});
