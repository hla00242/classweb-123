<?php
/**
 * HIS-1211 Dynamic Markdown & Historical Paper Reader
 */
require_once __DIR__ . '/../includes/functions.php';

$paperFile = $_GET['paper'] ?? 'primary-source-analysis.md';
$paperFile = basename($paperFile);
$fullPath = __DIR__ . '/' . $paperFile;

$defaultTitle = 'HIS-1211 Paper Reader';
...
$pageTitle = $defaultTitle . ' | HIS-1211 Reader';
$metaDescription = "Read '" . $defaultTitle . "' by Hesten A. (Sheldon) for HIS-1211 U.S. History to 1877.";
$activePage = 'courses';
$rootPath = '../';
...
<main class="reader-container">
    <nav class="breadcrumb-nav" aria-label="Breadcrumb">
        ...
        <a href="index.php">HIS-1211</a>
        <span class="breadcrumb-separator">/</span>
        <span id="breadcrumb-paper-title"><?= e($defaultTitle) ?></span>
    </nav>

    <header id="academic-header" class="academic-header">
        <span id="paper-badge" class="academic-header-tag">HIS-1211 &bull; Primary Source Essay</span>
        ...
        <div class="academic-meta-grid">
            ...
            <div class="meta-item">
                ...
                <span id="paper-course" class="meta-value">HIS-1211: U.S. History to 1877</span>
            </div>
            <div class="meta-item">
    ...
    <section class="citation-box" id="citation-box">
        ...
        <div id="citation-text" class="citation-text">
            Sheldon, Hesten A. "<?= e($defaultTitle) ?>." HIS-1211: U.S. History to 1877, Community College of Vermont / Vermont State Colleges, 2026.
        </div>
    </section>
    ...
    <footer class="reader-nav-footer">
        <div class="paper-nav-card">
            ...
            <a href="index.php" class="paper-nav-link">&larr; Back to HIS-1211 Hub</a>
        </div>
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        document.getElementById('paper-title').textContent = parsed.meta.title || 'Historical Essay';
        document.title = `${parsed.meta.title} | HIS-1211 Reader`;
        ...
        document.getElementById('citation-text').textContent = 
            `Sheldon, Hesten A. "${parsed.meta.title}." HIS-1211: U.S. History to 1877, Community College of Vermont / Vermont State Colleges, 2026.`;
    } catch (err) {
        document.getElementById('paper-content').innerHTML = `
            <div style="padding: 2rem; background: var(--status-warning-bg); border-radius: var(--radius-md); border: 1px solid var(--status-warning);">
                ...
                <p>Ensure <code>${paperFile}</code> exists in the <code>his1211/</code> directory.</p>
            </div>
        `;
    }
});
