<?php
/**
 * EDU-1030: Introduction to Special & Secondary Education - Course Dashboard
 */
require_once __DIR__ . '/../includes/functions.php';

$pageTitle = 'EDU-1030: Intro to Special & Secondary Education | Course Hub';
$metaDescription = 'Academic Coursework, UDL Blueprints, and Case Studies for EDU-1030 at CCV / Vermont State Colleges.';
$activePage = 'courses';
$rootPath = '../';
...
<main class="container" style="padding-top: 3rem; padding-bottom: 5rem;">
    ...
    <nav aria-label="Breadcrumbs" style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem; margin-bottom: 2rem;">
        ...
        <span style="color: var(--text-muted);">&bull;</span>
        <span style="color: var(--text-primary); font-weight: 600;">EDU-1030</span>
    </nav>
    ...
    <section class="course-featured-card" style="margin-bottom: 3.5rem;">
        <div class="course-header-row">
            <div>
                <span class="course-code-badge">EDU-1030 &bull; CCV / Vermont State Colleges</span>
                <h1 class="course-title" style="font-size: 2.5rem; margin-top: 0.75rem;">
                    Introduction to Special &amp; Secondary Education
                </h1>
            </div>
        ...
        <p class="course-desc" style="font-size: 1.15rem;">
            An introduction to pedagogical foundations, special education legislation (IDEA, Section 504), Individualized Education Programs (IEPs), differentiated instruction, and Universal Design for Learning (UDL) in secondary school classrooms.
        </p>

        <div class="hero-stats" style="margin-top: 2rem;">
            <div class="stat-item">
                <span class="stat-number gradient-text">Hesten A.</span>
                <span class="stat-label">Future Educator</span>
            </div>
            <div class="stat-item">
                <span class="stat-number"><?= count($discoveredPapers) ?> Completed</span>
                <span class="stat-label">Discovered Case Studies</span>
            </div>
            <div class="stat-item">
                <span class="stat-number">SPED &bull; UDL</span>
                <span class="stat-label">Inclusive Pedagogy</span>
            </div>
        </div>
    </section>
    ...
    <section id="papers" class="section" style="padding: 0 0 4rem 0;">
        <div class="section-header" style="text-align: left; margin-bottom: 2.5rem; max-width: 100%;">
            <span class="section-tag">Clinical Reflections &amp; Case Studies</span>
            <h2 class="section-title">Special Education &amp; Pedagogy Portfolio</h2>
            <p class="section-subtitle">Drop any <code>.md</code> file into this <code>edu1030/</code> directory to automatically publish and read it with audio narration.</p>
        </div>
    ...
    <section class="takeaways-box" style="background: var(--bg-card); margin-bottom: 3.5rem;">
        <h3 class="takeaways-title">
            ...
            How to Add New Papers &amp; Readings to EDU-1030
        </h3>
        <p style="margin-bottom: 1rem; color: var(--text-secondary);">
            To add a new special education case study, lesson plan reflection, or reading note:
        </p>
        <ol class="takeaways-list" style="list-style: decimal; padding-left: 1.25rem;">
            <li>Save your document as a markdown file in the <code>edu1030/</code> folder (e.g. <code>edu1030/udl-lesson-plan.md</code>).</li>
