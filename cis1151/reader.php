<?php
/**
 * CIS-1151 Dynamic Markdown & Technical Paper Reader
 */
require_once __DIR__ . '/../includes/functions.php';

$paperFile = $_GET['paper'] ?? 'pure-css-architecture.md';
$paperFile = basename($paperFile);
$fullPath = __DIR__ . '/' . $paperFile;

$defaultTitle = 'CIS-1151 Paper Reader';
...
$pageTitle = $defaultTitle . ' | CIS-1151 Reader';
$metaDescription = "Read '" . $defaultTitle . "' by Hesten A. (Sheldon) for CIS-1151 Websites & Web App Design.";
$activePage = 'courses';
$rootPath = '../';
...
<main class="reader-container">
    <nav class="breadcrumb-nav" aria-label="Breadcrumb">
        ...
        <a href="index.php">CIS-1151</a>
        <span class="breadcrumb-separator">/</span>
        <span id="breadcrumb-paper-title"><?= e($defaultTitle) ?></span>
    </nav>

    <header id="academic-header" class="academic-header">
        <span id="paper-badge" class="academic-header-tag">CIS-1151 &bull; Technical Paper</span>
        ...
        <div class="academic-meta-grid">
            ...
            <div class="meta-item">
                ...
                <span id="paper-course" class="meta-value">CIS-1151: Websites & Web App Design</span>
            </div>
            <div class="meta-item">
    ...
    <section class="citation-box" id="citation-box">
        ...
        <div id="citation-text" class="citation-text">
            Sheldon, Hesten A. "<?= e($defaultTitle) ?>." CIS-1151: Websites & Web Application Design, Community College of Vermont / Vermont State Colleges, 2026.
        </div>
    </section>
    ...
    <footer class="reader-nav-footer">
        <div class="paper-nav-card">
            ...
            <a href="index.php" class="paper-nav-link">&larr; Back to CIS-1151 Hub</a>
        </div>
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        document.getElementById('paper-title').textContent = parsed.meta.title || 'Technical Paper';
        document.title = `${parsed.meta.title} | CIS-1151 Reader`;
        ...
        document.getElementById('citation-text').textContent = 
            `Sheldon, Hesten A. "${parsed.meta.title}." CIS-1151: Websites & Web Application Design, Community College of Vermont / Vermont State Colleges, 2026.`;
    } catch (err) {
        document.getElementById('paper-content').innerHTML = `
            <div style="padding: 2rem; background: var(--status-warning-bg); border-radius: var(--radius-md); border: 1px solid var(--status-warning);">
                ...
                <p>Ensure <code>${paperFile}</code> exists in the <code>cis1151/</code> directory.</p>
            </div>
        `;
    }
});
